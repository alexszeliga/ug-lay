...
import {
  compile
} from "./chunk-2DXNG6TV.js";
import "./chunk-STA257QL.js";
import "./chunk-LLTUNC3B.js";
import {
  __commonJS,
  __toESM
} from "./chunk-47E3HDAG.js";
...
async function mdxPlugin(options) {
  let filter = createFilter(/\.mdx$/), { presets } = options, mdxPluginOptions = (await presets.apply("options", {}))?.mdxPluginOptions, rehypeSlug = (await import("./rehype-slug-SPX3TUGT.js")).default, rehypeExternalLinks = (await import("./rehype-external-links-BT26BML7.js")).default;
  return {
