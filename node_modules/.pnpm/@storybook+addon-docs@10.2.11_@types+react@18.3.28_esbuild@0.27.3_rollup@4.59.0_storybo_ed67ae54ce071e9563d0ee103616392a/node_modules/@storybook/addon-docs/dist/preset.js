import CJS_COMPAT_NODE_URL_8ck8onh3xnj from 'node:url';
import CJS_COMPAT_NODE_PATH_8ck8onh3xnj from 'node:path';
import CJS_COMPAT_NODE_MODULE_8ck8onh3xnj from "node:module";

var __filename = CJS_COMPAT_NODE_URL_8ck8onh3xnj.fileURLToPath(import.meta.url);
var __dirname = CJS_COMPAT_NODE_PATH_8ck8onh3xnj.dirname(__filename);
var require = CJS_COMPAT_NODE_MODULE_8ck8onh3xnj.createRequire(import.meta.url);

// ------------------------------------------------------------
// end of CJS compatibility banner, injected by Storybook's esbuild configuration
// ------------------------------------------------------------
import "./_node-chunks/chunk-47E3HDAG.js";
...
var docs = (input = {}, options) => {
  ...
  let { plugins = [] } = config, { mdxPlugin } = await import("./_node-chunks/mdx-plugin-ILVEE3VG.js"), { react, reactDom, mdx } = await getResolvedReact(options), packageDeduplicationPlugin = {
