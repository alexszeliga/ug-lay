import CJS_COMPAT_NODE_URL_t4z68euyco9 from 'node:url';
import CJS_COMPAT_NODE_PATH_t4z68euyco9 from 'node:path';
import CJS_COMPAT_NODE_MODULE_t4z68euyco9 from "node:module";

var __filename = CJS_COMPAT_NODE_URL_t4z68euyco9.fileURLToPath(import.meta.url);
var __dirname = CJS_COMPAT_NODE_PATH_t4z68euyco9.dirname(__filename);
var require = CJS_COMPAT_NODE_MODULE_t4z68euyco9.createRequire(import.meta.url);
...
var core = {
  ...
  if (reactDocgenOption === "react-docgen-typescript" && typescriptPresent && plugins.push(
    ...
    let { reactDocgen } = await import("./_node-chunks/react-docgen-SSJWP4W4.js");
    plugins.unshift(
