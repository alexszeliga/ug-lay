...
function action(name, options = {}) {
  let actionOptions = {
    ...
    var _a, _b;
    if (options.implicit) {
      let storyRenderer = (_a = "__STORYBOOK_PREVIEW__" in import_global.global ? import_global.global.__STORYBOOK_PREVIEW__ : void 0) == null ? void 0 : _a.storyRenders.find(
        (render) => render.phase === "playing" || render.phase === "rendering"
      );
      if (storyRenderer) {
        let deprecated = !((_b = globalThis == null ? void 0 : globalThis.FEATURES) == null ? void 0 : _b.disallowImplicitActionsInRenderV8), error = new import_preview_errors.ImplicitActionsDuringRendering({
...
//# sourceMappingURL=chunk-RK7FUZ5L.js.map
