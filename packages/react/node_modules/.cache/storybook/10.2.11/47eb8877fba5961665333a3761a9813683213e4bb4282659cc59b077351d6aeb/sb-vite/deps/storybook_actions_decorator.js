...
// ../../node_modules/.pnpm/storybook@10.2.11_@testing-library+dom@10.4.1_react-dom@18.3.1_react@18.3.1__react@18.3.1/node_modules/storybook/dist/actions/decorator.js
...
var withActions = (0, import_preview_api.makeDecorator)({
  ...
  wrapper: (getStory, context, { parameters }) => ((parameters == null ? void 0 : parameters.handles) && applyEventHandlers(actions, ...parameters.handles), getStory(context))
});
export {
  withActions
};
