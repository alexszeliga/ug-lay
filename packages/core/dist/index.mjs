...
var LayoutEngine = class {
  ...
  swapTiles(sourceId, targetId) {
    const sourceNode = this.findNode(this.state.root, sourceId);
    const targetNode = this.findNode(this.state.root, targetId);
  ...
  recursiveSwap(node, idA, idB, dataA, dataB) {
